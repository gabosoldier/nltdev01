    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <?php echo form_open_multipart('device/create', $attributes); ?>
                ...
                <div class="form-group <?php echo form_error('name') ? 'has-error' : '' ?>">
                    ...
                    <input name="name" placeholder="Eneter name" class="form-control">
                </div>
                ...
                <div class="form-group <?php echo form_error('date') ? 'has-error' : '' ?>">
                    ...
                    <textarea name="date" placeholder="Enter date" class="form-control"></textarea>
                </div>
                <div class="form-group <?php echo form_error('hour') ? 'has-error' : '' ?>">
                    <label class="control-label">Enter Hour</label>
                    <textarea name="hour" placeholder="Enter Hour" class="form-control"></textarea>
                </div>
                <div class="form-group <?php echo form_error('userid') ? 'has-error' : '' ?>">
                    <label class="control-label">Enter user id</label>
                    <textarea name="userid" placeholder="Enter user id" class="form-control"></textarea>
                </div>
